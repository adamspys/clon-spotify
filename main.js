...
/*             BOTON PLAY             */
/* ********************************** */
const containerPopularArtists = document.querySelectorAll(
	'.card-popular-artists'
);
const containerPopularAlbums = document.querySelectorAll(
	'.card-popular-albums'
);
...
containerPopularArtists.forEach(card => {
	createButton(card);
});

containerPopularAlbums.forEach(card => {
	createButton(card);
});
